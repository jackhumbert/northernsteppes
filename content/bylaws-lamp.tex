...
\begin{level}
    ...
    \begin{level}
        ...
        \item \chadded{Entrance to all Northern Steppes non-overnight events, such as:}
        \begin{level}
    ...
    \begin{level}
        \item \chadded[comment=Discount and/or standard rate may be adjusted---we could remove it from the bylaws \& let the Council decide it on a yearly basis.]{To encourage registering at the beginning of a season, any registration prior to May 1st will receive a discount of \$5.} 
