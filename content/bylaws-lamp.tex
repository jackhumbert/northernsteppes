...
\begin{level} 
    ...
    \end{level}
    \item During any member meeting, \replaced[comment=This wording was confusing\, and as our membership grows\, it may be impossible to get this many people. 50\% + 1 is safer\, and will prevent minority rule.]{the quorum shall consist of 50\% of members plus one (1)}{Quorum is defined as 75\% of the subject in question. This applies to all votes and attendance of meetings. Regarding votes, a vote of “abstain” is not included in the total count of those present for that issue}.
\end{level}
